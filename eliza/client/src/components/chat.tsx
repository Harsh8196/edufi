                                    ...
                                    <div className="flex flex-col">
                                        ...
                                        >
                                            {message?.user !== "user" ? (
                                                ...
                                                components={{
                                                    p: ({node, ...props}) => <p className="mb-0 last:mb-0 whitespace-pre-line" {...props} />,
                                                    a: ({node, ...props}) => <a className="text-[#7f00ff] hover:underline cursor-pointer" {...props} />,
                                                    ul: ({node, ...props}) => <ul className="list-disc list-inside mb-0" {...props} />,
                                                    ol: ({node, ...props}) => <ol className="list-decimal list-inside mb-0" {...props} />,
                                                    ...
                                                    h1: ({node, ...props}) => <h1 className="text-lg font-bold mb-0" {...props} />,
                                                    h2: ({node, ...props}) => <h2 className="text-base font-bold mb-0" {...props} />,
                                                    h3: ({node, ...props}) => <h3 className="text-sm font-bold mb-0" {...props} />,
