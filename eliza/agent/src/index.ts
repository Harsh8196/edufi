...
import { edufiCharacter } from "./edufiCharacter";

import { bootstrapPlugin } from "@elizaos/plugin-bootstrap";
import { edufiPlugin } from "@elizaos/plugin-edufi";
...
export async function loadCharacters(
    ...
    if (loadedCharacters.length === 0) {
        ...
        loadedCharacters.push(edufiCharacter);
    }
